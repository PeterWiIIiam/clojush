...
; Define the argmap
(def argmap
  {:error-function (make-last-index-of-zero-error-function-from-cases (take 5 (first last-index-of-zero-train-and-test-cases))
                                                                      (take 5 (second last-index-of-zero-train-and-test-cases)))
