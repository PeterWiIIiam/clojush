...
; Define the argmap
(def argmap
  {:error-function (make-negative-to-zero-error-function-from-cases (take 5 (first negative-to-zero-train-and-test-cases))
                                                            (take 5 (second negative-to-zero-train-and-test-cases)))
