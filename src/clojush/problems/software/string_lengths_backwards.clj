...
; Define the argmap
(def argmap
  {:error-function (make-string-lengths-backwards-error-function-from-cases (take 5 (first string-lengths-backwards-train-and-test-cases))
                                                                            (take 5 (second string-lengths-backwards-train-and-test-cases)))
